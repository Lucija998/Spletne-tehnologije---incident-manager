...
<div class="d-flex justify-content-center align-items-center" style="height: 100vh;">
    <div class="card shadow" style="width: 400px; background-color: #4a5a82; color: white; border-radius: 10px;">
        <div class="card-body">
            ...
            <form action="<?php echo e(route('incident.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\incident-manager\resources\views/incident_form.blade.php ENDPATH**/ ?>